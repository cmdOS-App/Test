...
import type { InstalledModule } from './searchEngine';
      ...
      match =>
        ...
        (match.type === 'snippet' &&
          ...
          (match.snippet.category === 'link' ||
            ...
            match.snippet.category === 'tabgroup' ||
            match.snippet.category === 'tab group')),
    );
              ...
              {hasNoResults ? (
                ...
                actionableMatches.map((match, idx) => {
                  ...
                  if (isSnippet && match.snippet?.shortcuts) {
                    const shortcuts = match.snippet.shortcuts.split(',').map(s => s.trim());
