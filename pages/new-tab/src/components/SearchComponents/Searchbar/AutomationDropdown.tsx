...
import { FaCheck, FaEdit, FaTimes, FaChevronDown } from 'react-icons/fa';

export type AutomationDropdownItem = {
  id: string;
  label: string;
  value: string;
  kind?: 'option' | 'history';
...
const AutomationDropdown: React.FC<AutomationDropdownProps> = ({
  items,
  query,
  selectedValue,
  onSelect,
