...
import type { AutomationDropdownItem } from './AutomationDropdown';
import AutomationDropdown from './AutomationDropdown';
import { resolvePlaceholderFromCmd } from './Searchbar';
...
export interface AutomationInputsProps {
  title: string;
  automation?: any;
...
const AutomationInputs: React.FC<AutomationInputsProps> = ({
  title,
  automation,
  anchorRef,
  fields,
          ...
          <div
            ...
            <div
              ...
              {orderedFields.map((entry, displayIndex) => {
                ...
                const dropdownItems: AutomationDropdownItem[] = [...predefinedItems, ...historyItemsForField];
