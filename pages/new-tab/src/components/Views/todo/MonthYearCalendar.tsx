...
const MonthYearCalendar: React.FC<MonthYearCalendarProps> = ({ selectedDate, onDateChange, tasks = [] }) => {
  ...
  const selectedDateTasks = tasks.filter(t => !t.is_done && isSameDay(new Date(t.event_deadline), selectedDate));
