...
interface AgentOptionPopupProps {
  // Agent mode props
...
const AgentOptionPopup: React.FC<AgentOptionPopupProps> = ({
  initialPrompts,
  initialKey = '',
  initialValues = [''],
  isAllAi = false,
  ...
  useEffect(() => {
    const handleEscapeKey = (e: KeyboardEvent) => {
      ...
      // Don't close if the event is from inside a param-menu dropdown (let it handle its own Escape)
      const target = e.target as HTMLElement;
      if (target?.closest?.('[data-param-menu="true"]')) return;
      e.preventDefault();
      e.stopPropagation();
      onClose();
    };
                  ...
                  <img
                    src={
                      typeof chrome !== 'undefined' && chrome.runtime?.getURL
                        ? chrome.runtime.getURL('new-tab/images/how_to_Select_intro.gif')
                        : '/new-tab/images/how_to_Select_intro.gif'
                    }
...
export default AgentOptionPopup;
export { ParamBadge };
