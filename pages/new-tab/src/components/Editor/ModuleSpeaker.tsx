...
import type { ModuleDefinition } from '../../../../../chrome-extension/src/background/automationExecutor';
...
const ModuleSpeaker: React.FC<ModuleSpeakerProps> = ({
  onClose,
  insertPoint,
  steps,
  setSteps,
  ...
  useEffect(() => {
    const checkSub = async () => {
      try {
        ...
        console.error('Failed to read sub in ModuleSpeaker:', err);
      }
    };
    checkSub();
