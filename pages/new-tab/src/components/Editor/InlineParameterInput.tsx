...
import type { InlineParamConfig } from './AgentPanelTypes';

export type InlineParameterInputProps = {
  value: string;
...
// -- Main Component: InlineParameterInput --
export const InlineParameterInput = React.forwardRef<HTMLInputElement, InlineParameterInputProps>(
  (
    {
      value,
      paramConfigs,
