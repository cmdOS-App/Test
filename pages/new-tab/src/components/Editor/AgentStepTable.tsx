...
import { HighlightedInput, formatParamBadgeName } from './AgentOptionPopup';
import { convertLegacyParams } from './AgentPanelUtils';
import { InlineParamConfig } from './AgentPanelTypes';
import {
  DndContext,
  closestCenter,
  KeyboardSensor,
...
import type { AutomationStep } from '../../../../utils/automation';

interface AgentStepTableProps {
...
const AgentStepTable: React.FC<AgentStepTableProps> = ({
  steps,
  selectedStepId,
  onSelectStep,
  onAddStep,
